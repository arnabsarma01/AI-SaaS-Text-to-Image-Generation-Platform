    ...
    <motion.form onSubmit={onsubmitHandler}
     ...
     className=' relative bg-white p-10 rounded-xl text-slate-500'>
        ...
        { state !=='Login' && <div className=' border px-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img src={assets.profile_icon} alt="" width={16} className=' '/>
        ...
        <button className=' bg-blue-600 w-full cursor-pointer text-white py-2 rounded-full'>{state === 'Login' ? 'Login' : 'create account'}</button>
