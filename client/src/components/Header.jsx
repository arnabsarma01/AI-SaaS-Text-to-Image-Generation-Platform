  ...
  return (
    ...
    >
      ...
      <motion.p className=' text-center max-w-xl mx-auto mt-5'
        ...
        animate={{opacity:1,y:0}}
        ransition={{delay:0.6,duration:0.8}}
      >Unleash your creativity with AI. Turn your imagination into isual art in seconds - just type, and watch the magic happen</motion.p>
